      ...
      <div style={{ 
        ...
        <div style={{ maxWidth: '420px', width: '100%' }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ color: 'var(--ai-text-secondary)' }}>登录你的账户</p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <span style={{ color: 'var(--ai-text-muted)', fontSize: '0.875rem' }}>还没有账号？</span>
              <Link to="/register" style={{ color: 'var(--ai-accent-green)', fontWeight: 500, fontSize: '0.875rem', textDecoration: 'none', marginLeft: '0.375rem' }}>
                立即注册
              </Link>
            </div>
          </div>
